...
import styles from './../componentes/SeleccionarImagen.module.css';
export default function SeleccionarImagen(props: SeleccionarImagenProps){
    ...
    return(
        <div className="form-group">
            ...
            {imagenBase64 ? <div><div className={styles.div}><img src={imagenBase64} alt="img seleccionada" /></div></div> : undefined}
            {imagenURL ? <div><div className={styles.div}><img src={imagenURL} alt="img actor" /></div></div> : undefined}
        </div>
    )
}
